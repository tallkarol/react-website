...
// Create service icon components separately to keep the data structure cleaner
...
export const services: ServiceDetails[] = [
  ...
  },
  {
    ...
    icon: getServiceIcon('automation'),
    iconType: 'automation',
    features: [
      "Workflow automation",
      "Document processing",
