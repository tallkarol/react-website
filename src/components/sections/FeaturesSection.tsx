...
const FeaturesSection = () => {
  ...
  const features: Feature[] = [
    {
      ...
      description: "Get deep insights into your business performance with our powerful analytics tools. Visualize trends, track key metrics, and make data-driven decisions.",
      icon: "chart-bar",
      benefits: ["Real-time dashboard", "Custom reports", "Trend prediction", "Data visualization"]
    },
    {
      id: "automation",
      title: "Workflow Automation",
      description: "Streamline your operations by automating repetitive tasks. Set up custom workflows, triggers, and actions to increase efficiency and reduce human error.",
      icon: "cog",
      benefits: ["Task automation", "Custom workflows", "Scheduled actions", "Integration with other tools"]
    },
    {
      id: "collaboration",
      title: "Team Collaboration",
      description: "Foster teamwork with our suite of collaboration tools. Share documents, communicate in real-time, and track project progress all in one central location.",
      icon: "users",
      benefits: ["Real-time chat", "Document sharing", "Task assignment", "Progress tracking"]
    },
    {
      id: "security",
      title: "Enterprise Security",
      description: "Protect your sensitive data with enterprise-grade security measures. Our platform utilizes the latest encryption standards and security protocols.",
      icon: "shield-check",
      benefits: ["End-to-end encryption", "Role-based access control", "Audit logs", "Compliance tools"]
    }
  ];
  ...
  // Return the icons for the features
            ...
            <div className="flex overflow-x-auto hide-scrollbar pb-2 justify-center">
              <div className="inline-flex p-1.5 rounded-xl shadow-xl"
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    <span className="w-5 h-5">{getFeatureIcon(feature.icon)}</span>
                    {feature.title}
